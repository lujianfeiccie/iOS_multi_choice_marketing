...
- (void)viewDidLoad
{
    ...
    model.m_text = @"2013年4月真题";
    model.m_value = @"2013_04";
    [m_datalist addObject:model];
    
    model = [[ModelData alloc]init];
    model.m_text = @"2012年4月真题";
    model.m_value = @"2012_04";
    [m_datalist addObject:model];
    
    model = [[ModelData alloc]init];
    model.m_text = @"2011年4月真题";
    model.m_value = @"2011_04";
    [m_datalist addObject:model];
    
    model = [[ModelData alloc]init];
    model.m_text = @"2010年4月真题";
    model.m_value = @"2010_04";
    [m_datalist addObject:model];

    model = [[ModelData alloc]init];
    model.m_text = @"2009年4月真题";
    model.m_value = @"2009_07";
    [m_datalist addObject:model];
...
-(void) threadSearch :(NSString*) keywords
{
    ...
    NSArray* mutli_short_answer_filename = [NSArray arrayWithObjects:
                                            @"2013_04_short_answer",
                                            @"2012_04_short_answer",
                                            @"2011_04_short_answer",
                                            @"2010_04_short_answer",
                                            @"2009_07_short_answer",
                                            nil];
